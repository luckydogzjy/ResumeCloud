		...
		<div id="left">
			...
			<div id="left-item">
				...
				<div id="left-item-resume" class="left-item" >
					...
					<a class="left-item-a" href="${pageContext.request.contextPath}/Resume/getResumeListByCondition.do">简历管理</a>
					</div>
				</div>
				...
				<div id="left-item-quit" class="left-item">
					...
					<a class="left-item-a" href="${pageContext.request.contextPath}/gologin1.action">退出登录</a>
					</div>
				</div>
			</div>
		</div>
