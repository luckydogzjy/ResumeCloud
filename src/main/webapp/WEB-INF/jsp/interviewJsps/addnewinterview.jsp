							...
							<form action="${pageContext.request.contextPath }/Interview/newInterview.do" onsubmit="return formcheck()">
								...
								<table cellSpacing="5" cellPadding="4">
									...
									<tr>
										...
										<td colspan="2"><input type="text" id="job"  onblur="checkJob(this.value)" onchange="check(this.value,'interviewJob')" value="${resume.resumeJobIntension}" v-model="interviewJob" />
										</td>
