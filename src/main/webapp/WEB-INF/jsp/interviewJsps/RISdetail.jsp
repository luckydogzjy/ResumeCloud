				...
				<div id="right-box" class="right-box">
					...
					<div class="timespan">
						...
						<ul>
							...
							<li><a href="#${interview.interviewTime}"><fmt:formatDate value="${interview.interviewTime}" pattern="yyyy年MM月dd日 HH:mm" /> </a></li>
							</c:forEach>
						</ul>
					</div>
					<div class="msg">
						<c:forEach items="${resumeInterviews.interviews}" var="interview">
							面试时间：<a name="${interview.interviewTime}"><fmt:formatDate value="${interview.interviewTime}" pattern="yyyy年MM月dd日 HH:mm" /> </a> <br /> 
							面试职位：<font size="2">${interview.interviewJob}</font> <br /> 
							面试地点：<font size="2">${interview.interviewAddress}</font> <br /> 
							面试结果：
							<font size="2">
							...
							<input type="button" class="updatebtn" name="" id="" value="编辑" /> <br />
							 -------------------------------------------------------- <br />
						</c:forEach>
					</div>
