...
<body>
	...
	<table border="1" width="50%">
		...
		<tbody>
			...
			<tr>
				<td><a href="<%=request.getContextPath() %>/resumeDetails.do?resumeId_Details=${resume.resumeId }" >${resume.resumeName }</a></td>
				<td>
				...
				<td><fmt:formatDate value="${resume.resumeCreateTime }" pattern="yyyy-MM-dd HH:mm"/></td>
	...
	<%-- 				<c:if test="${resume.interview.interviewStatus != 1 
				...
				<td>
					...
					<c:if test="${resume.userResume.urResumeGetway == 1 
									&&  resume.userResume.urResumeShareFlag == 1}">
