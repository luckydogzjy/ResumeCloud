...
<html>
	...
	<body>
		...
		<div id="right">
			...
			<div id="details"  style="position: absolute;left:50%;top:40%;margin-left:-100px; margin-top:-100px;"> 
			...
			<div style="position: absolute;left:50%;top:90%;margin-left:-100px; margin-top:-100px;">
			<input onclick="copy()" type="button" value="复制到剪切板">
			</div>
