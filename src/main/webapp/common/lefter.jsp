			...
			<div id="left-item">
				<div id="left-item-share" class="left-item" >
					<div class="left-item-box">
						<img class="left-item-pic"  src="../img/u21.png" />
				...
				<div id="left-item-resume" class="left-item" >
					<div class="left-item-box">
					<img class="left-item-pic" src="../img/u13.png" />
				...
				<div id="left-item-job" class="left-item">
					<div class="left-item-box">
					<img class="left-item-pic" src="../img/u12.png" />
				...
				<div id="left-item-interview"  class="left-item">
					<div class="left-item-box">
					<img class="left-item-pic" src="../img/u15.png" />
					<a class="left-item-a" href="#">面试安排</a>
					</div>
				</div>

				<div id="left-item-person"  class="left-item" >
					<div class="left-item-box">
					<img class="left-item-pic" src="../img/u14.png" />
				...
				<div id="left-item-quit" class="left-item">
					<div class="left-item-box">
					<img class="left-item-pic" src="../img/u19.png" />
